...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, config, document, expressApp;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, (0, serverless_express_1["default"])({ app: expressApp })];
            }
        });
    });
}
var handler = function (event, context, callback) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!(server !== null && server !== void 0)) return [3 /*break*/, 1];
                _a = server;
                return [3 /*break*/, 3];
            case 1: return [4 /*yield*/, bootstrap()];
            case 2:
                _a = (_b.sent());
                _b.label = 3;
            case 3:
                server = _a;
                return [2 /*return*/, server(event, context, callback)];
        }
    });
}); };
